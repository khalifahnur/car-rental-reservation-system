  ...
  return (
    <>
      <div className="min-h-screen flex">
        {/* Sidebar */}
        <div className=" sticky top-0 left-0 w-1/12 bg-orange-500 p-4 flex flex-col justify-between shadow-lg text-white">
          <div>
            <Link href={"/"}>
              <Image
                src="/logo.svg"
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center md:flex-row md:justify-between">
              ...
              <button onClick={()=>HandleSignOut()} className=" md:ml-4 text-sm text-center">Logout</button>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <div className="mt-1 block w-full p-2 border border-gray-300 rounded-md">{userData.displayName}</div>
              </div>
              <div>
                <label className="block text-gray-700">Email</label>
                <div className="mt-1 block w-full p-2 border border-gray-300 rounded-md">{userData.email}</div>
              </div>
            </div>
          </div>
